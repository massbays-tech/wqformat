test_that("fetch_var works", {
  ...
  var_order <- fetch_var(df, "col2", "col1")
  ...
  var_num <- fetch_var(df, "col1", "col3")
  ...
  var_equal <- fetch_var(df, "col3", "col3")
